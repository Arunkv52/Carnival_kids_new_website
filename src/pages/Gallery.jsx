...
const Gallery = () => {
  return (
    <>
      <div className="blog-main md:py-40 md:pt-0 md:pb-10 pt-60 pb-10">
        <Header />
        ...
        <div className="blog-area md:absolute md:top-1/4 md:left-1/3 absolute top-40 flex flex-col justify-center items-center text-center">
          <h1 className="text-5xl font-bold py-2">Gallery</h1>
          <p className="text-base">
            Little hands, big discoveries. Every day is an adventure.
          </p>
        </div>
      </div>
      <div>
