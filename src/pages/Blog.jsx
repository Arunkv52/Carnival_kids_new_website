  ...
  return (
    <>
      <div className='blog-main py-20'>
        ...
        <div className='blog-area absolute top-1/3 left-1/3 flex flex-col justify-center items-center text-center'>
          <h2 className='bg-red-500 max-w-fit px-8 py-2 rounded-[50px] text-white shadow-2xl'>
            Blog Areas
          </h2>
          <h1 className='text-5xl font-bold py-2'>News Insights !</h1>
