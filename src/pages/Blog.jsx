...
import BlogImg from '../assets/Gallery.jpg'
  ...
  return (
    <>
      <div className='blog-main md:py-20 md:pt-0 md:pb-10 pt-60 pb-10'>
        ...
        <div className='blog-area md:absolute md:top-1/3 md:left-1/3 absolute top-30 flex flex-col justify-center items-center text-center'>
          <h2 className='bg-red-500 max-w-fit px-8 py-2 rounded-[50px] text-white shadow-2xl'>
            Blog Areas
          </h2>
          <h1 className='md:text-5xl text-3xl font-bold py-2'>News Insights !</h1>
      ...
      <div className='blog-main-content py-10'>
        <BlogCard />
      </div>
      <Footer />
    </>
