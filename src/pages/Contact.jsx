    ...
    <>
      ...
      <div className='form-place md:px-20 px-5 md:py-20 py-5 md:flex justify-around'>
        ...
        <div className='md:w-1/2 w-full'>
          <form onSubmit={handleSubmit(contactData)} className='md:px-10 px-0 py-0 rounded-2xl'>
            {/* Parent name */}
            <div className='py-2'>
            ...
            <div className='py-2'>
              ...
              {errors.enquiry && <p className='text-red-500'>{errors.enquiry.message}</p>}

            </div>
            <div className='py-2'>
              <label htmlFor='date' className='text-black/50'>Select date of birth</label>
              <input
                type='date'
                name='date'
                id=''
            ...
            <div className='py-2'>
              ...
              />
              {errors.alttel && <p className='text-red-500'>{errors.alttel.message}</p>}
