        ...
        <div className="max-w-sm bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
          ...
          <div className="p-6">
            <div className="flex items-center text-gray-500 text-sm gap-4 mb-2">
              <span className="flex items-center gap-1">👤 Dynamiclayers</span>
            ...
            <p className="text-gray-600 text-sm mt-3">
              ...
              businesses. From social media platforms to search engine...
            </p>

            {/* Footer */}
            <Link to={'/why-montessori'}>
              <div className="flex justify-between items-center mt-4 pt-3 border-t border-gray-100 text-sm r">
                <button className="flex items-center gap-1 text-orange-600 hover:underline font-medium cursor-pointer">
                  Read More →
                </button>
              </div>
            </Link>
